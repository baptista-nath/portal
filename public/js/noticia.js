  ...
  if (!noticiaId) {
    container.innerHTML = `
      <div class="text-center py-12">
        <p class="text-red-600 text-lg">ID da notícia não encontrado.</p>
        <a href="/" class="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
          Voltar para Home
        </a>
      </div>
    `;
  ...
  try {
    ...
    container.innerHTML = `
      <article class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-8">
          ...
          ${noticia.subtitulo ? `
            <p class="text-xl text-gray-700 font-medium mb-6">${noticia.subtitulo}</p>
          ` : ''}
      ...
      <div class="mt-8 text-center">
        <a href="/" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition inline-flex items-center">
    ...
    container.innerHTML = `
      <div class="text-center py-12">
        ...
        <p class="mt-4 text-xl text-red-600">Erro ao carregar notícia. Notícia não encontrada.</p>
        <a href="/" class="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
          Voltar para Home
        </a>
      </div>
